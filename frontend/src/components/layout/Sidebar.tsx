...
const menuItems: MenuItem[] = [
  { icon: LayoutDashboard, label: 'Dashboard', path: '/dashboard', tourId: 'menu-dashboard' },
  {
    icon: BarChart3,
    label: 'Análise',
    path: '/dados',
    tourId: 'menu-dados',
    children: [{ label: 'Qualidade', path: '/dados/qualidade' }],
  },
  { icon: Hourglass, label: 'Maturação', path: '/maturacao' },
  { icon: Building2, label: 'Empreendimentos', path: '/empreendimentos' },
  { icon: Users, label: 'Leads', path: '/leads', tourId: 'menu-leads' },
  { icon: FileBarChart, label: 'Relatórios', path: '/relatorios', tourId: 'menu-relatorios' },
];
