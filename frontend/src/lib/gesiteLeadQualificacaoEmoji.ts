...
export type GesiteQualificacaoEmoji = {
  code: string;
  alt: string;
  label: string;
};

export const GESITE_QUALIFICACAO_EMOJI: Record<GesiteLeadQualificacao, GesiteQualificacaoEmoji> = {
...
export const GESITE_QUALIFICACAO_ACCENT: Record<
  GesiteLeadQualificacao,
